...
Griffins.namespace("Test");

Griffins.Test.Case = function(template) {
...
Griffins.Test.Suite = function(data) {
    /**
...
Griffins.Test.Suite.prototype = {
    /**
     * Adds a test suite or test case to the test suite.
     * @param {Griffins.Test.Suite||Griffins.Test.Case} testObject The test suite or test case to add.
     * @return {Void}
     * @method add
     */
    add : function (testObject /*:Griffins.Test.Suite*/) /*:Void*/ {
        if (testObject instanceof Griffins.Test.Suite || testObject instanceof Griffins.Test.Case) {
...
Griffins.Test.Runner = (function() {

    /**
     * A node in the test tree structure. May represent a Test Suite, Test Case, or
     * test function.
     * @param {Variant} testObject A Test Suite, Test Case, or the name of a test function.
     * @class TestNode
     * @constructor
     * @private
     */
    function TestNode(testObject /*:Variant*/){
        ...
        //initialize results
        if (testObject instanceof Griffins.Test.Suite){
            this.results.type = "testsuite";
            this.results.name = testObject.name;
        } else if (testObject instanceof Griffins.Test.Case){
    ...
    TestNode.prototype = {
        ...
        /**
         * Appends a new test object (Test Suite, Test Case, or test function name) as a child
         * of this node.
         * @param {Variant} testObject A Test Suite, Test Case, or the name of a test function.
         * @return {Void}
         */
    ...
    function TestRunner() {
         ...
         * @type Griffins.Test.TestSuite
         * @property masterSuite
         * @private
         * @static
         */
        this.masterSuite = new Griffins.Test.Suite("ND_ios_test" + (new Date()).getTime());
    ...
    Griffins.util.extend(TestRunner, Griffins.event.EventProvider, {
        /**
         ...
         * @param {Griffins.Test.Case} testCase The test case to add.
         * @return {Void}
         * @static
         * @private
         * @method _addTestCaseToTestTree
         */
        _addTestCaseToTestTree : function (parentNode /*:TestNode*/, testCase /*:Griffins.Test.Case*/) /*:Void*/{
            //add the test suite
            var node = parentNode.appendChild(testCase);
            
            //iterate over the items in the test case
            for (var prop in testCase){
                if (prop.indexOf("test") === 0 && Griffins.util.isFunction(testCase[prop])){
         ...
         * @param {Griffins.Test.Suite} testSuite The test suite to add.
         * @return {Void}
         * @static
         * @private
         * @method _addTestSuiteToTestTree
         */
        _addTestSuiteToTestTree : function (parentNode /*:TestNode*/, testSuite /*:Griffins.Test.Suite*/) /*:Void*/ {
            ...
            for (var i=0; i < testSuite.items.length; i++){
                if (testSuite.items[i] instanceof Griffins.Test.Suite) {
                    this._addTestSuiteToTestTree(node, testSuite.items[i]);
                } else if (testSuite.items[i] instanceof Griffins.Test.Case) {
        ...
        _buildTestTree : function () /*:Void*/ {
            ...
            for (var i=0; i < this.masterSuite.items.length; i++){
                if (this.masterSuite.items[i] instanceof Griffins.Test.Suite) {
                    this._addTestSuiteToTestTree(this._root, this.masterSuite.items[i]);
                } else if (this.masterSuite.items[i] instanceof Griffins.Test.Case) {
        ...
        getResults : function(format){
            if (!this._running && this._lastResults) {
                if (Griffins.util.isFunction(format)) {
        ...
        _handleTestObjectComplete : function (node /*:TestNode*/) /*:Void*/ {
            if (Griffins.util.isObject(node.testObject)){
         ...
         * @param {Griffins.Test.Case|Griffins.Test.Suite} testObject The test case or test suite to run.
        ...
        _run : function () /*:Void*/ {
            ...
            if (node !== null) {
                ...
                if (Griffins.util.isObject(testObject)){
                    if (testObject instanceof Griffins.Test.Suite){
        ...
        _resumeTest : function (segment /*:Function*/) /*:Void*/ {
            ...
            var testCase /*:Griffins.Test.Case*/ = node.parent.testObject;
         ...
         */
        clear : function () /*:Void*/ {
            this.masterSuite = new Griffins.Test.Suite("Griffins_ios_tests" + (new Date()).getTime());
        },
        ...
        run : function (oldMode) {
            ...
            if (mainVersion[0] < 5) {
                UIALogger.logFail("The Griffins cannot run on ios which version is less than 5");
                return;
            }
            var handleCompeleteResult = function(testresults) {
                    var reportfilename = System.createFile("test.xml")
                        var reporter = new Griffins.Test.Reporter(reportfilename);
                        reporter.report(testresults['results']);
                        UIALogger.logMessage("ALL test finished,and the report is: "+reportfilename);
            }
            Griffins.Test.Runner.subscribe(Griffins.Test.Runner.COMPLETE_EVENT, handleCompeleteResult);
            
            //pointer to runner to avoid scope issues 
            var runner = Griffins.Test.Runner;
            
            //if there's only one suite on the masterSuite, move it up
            if (!oldMode && this.masterSuite.items.length == 1 && this.masterSuite.items[0] instanceof Griffins.Test.Suite){
...
Griffins.namespace("Test.Format");

/**
 * Returns test results formatted in JUnit XML format.
 * @param {Object} result The results object created by TestRunner.
 * @return {String} An XML-formatted string of results.
 * @namespace Griffins.Test.Format
 * @method JUnitXML
 * @static
 */
Griffins.Test.Format.JUnitXML = function(results) {
 ...
 *      Default is Griffins.Test.Format.JUnitXML.
 * @constructor
 * @namespace Griffins.Test
 * @class TestReporter
 */
Griffins.Test.Reporter = function(path /*:String*/, format /*:Function*/) {

    this.path = path;

    this.format = format || Griffins.Test.Format.JUnitXML;
};
...
Griffins.Test.Reporter.prototype = {
